  ...
  <div class="container">
    ...
    <b-modal ref="addBookModal" id="book-modal" title="Add a new book" hide-footer>
      <b-form @submit="onSubmit" @reset="onReset" class="w-100">
        ...
        <b-form-group id="form-author-group" label="Author:"
        ...
        <b-form-group id="form-read-group">
          <b-form-checkbox v-model="addBookForm.read" value="true">Read?</b-form-checkbox>
        </b-form-group>
    ...
    <b-modal ref="editBookModal" id="book-update-modal" title="Update" hide-footer>
      <b-form @submit="onSubmitUpdate" @reset="onResetUpdate" class="w-100">
        ...
        <b-form-group id="form-read-edit-group">
          <b-form-checkbox v-model="editForm.read" value="true">Read?</b-form-checkbox>
        </b-form-group>
...
const path = 'http://192.168.0.64:5000/books';
...
export default {
  ...
  methods: {
    ...
    updateBook(payload, bookID) {
      const path1 = `${path}/${bookID}`;
      axios.put(path1, payload).then((res) => {
        this.getBooks();
        this.message = res.data.message;
        this.showMessage = true;
      }).catch((error) => {
